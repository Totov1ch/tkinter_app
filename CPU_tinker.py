...
from widget_updatae import Config_widget
...
class Application(tk.Tk, Config_widget):
    ...
    def set_ui(self):
        ...
        self.combo_win.pack(side=LEFT)

        ttk.Button(self.bar2, text="move", command=self.configure_win).pack(side=LEFT)
        ttk.Button(self.bar2, text=">>>").pack(side=LEFT)
